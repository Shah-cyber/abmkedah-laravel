<x-non-member-layout>
            ...
            <div class="relative">
                ...
                <div class="w-full items-center content-around">
                    ...
                    <hr class="border-gray-300 my-2">
                        ...
                        <form id="registrationForm" action="{{ route('event.register.nonmember', ['id' => $event->event_id]) }}" method="POST">
                        @csrf
                        ...
                        <div class="flex place-content-center justify-evenly">
                            ...
                            <div class="border-2 border-gray-400 w-3/5 content-around items-center flex-row flex rounded-lg m-2">
                                ...
                                <div class="p-2 w-full border-l-2 border-gray-400">
                                    ...
                                    <input class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" type="number" id="ic_number" name="ic_number" required>
                                </div>  
                            </div>
    ...
    <script>
            ...
            // Show SweetAlert based on status_id
            if (statusId === '1') {
                // Payment Success
                Swal.fire({
                    title: 'Payment Successful!',
                    text: 'Your payment was successful. Thank you for registering!',
                    icon: 'success',
                ...
                Swal.fire({
                    ...
                    text: 'Sorry, there was an issue with your payment. Please try again.',
                    icon: 'error',
                    confirmButtonText: 'OK'
                });
            }
