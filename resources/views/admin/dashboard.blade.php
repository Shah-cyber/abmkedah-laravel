<x-admin-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="text-3xl font-bold text-gray-900 mb-2">{{ $totalMembers }}</div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="text-3xl font-bold text-gray-900 mb-2">{{ $totalEvents }}</div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="text-3xl font-bold text-gray-900 mb-2">{{ number_format($totalMeritsAwarded, 2) }}</div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="text-3xl font-bold text-gray-900 mb-2">{{ $pendingApplications }}</div>
