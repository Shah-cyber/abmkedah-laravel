<x-admin-layout>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h1 class="text-2xl font-bold text-gray-800">Add New Payment</h1>
                <p class="text-sm text-gray-600 mt-1">Create a new payment allocation</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6">
            <form id="feeCollectionForm" class="space-y-6">
        @csrf
            ...
            <!-- Payment Type -->
                        <div class="space-y-2">
                            <label for="payment-type" class="text-sm font-medium text-gray-700">
                                Payment Type
                                <span class="text-red-500">*</span>
                            </label>
