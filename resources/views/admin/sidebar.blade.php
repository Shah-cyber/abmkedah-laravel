    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-950">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-950">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('admin.dashboard') }}" 
                       class="flex items-center p-2 rounded-lg text-white group transition-all duration-200 ease-in-out
                              {{ request()->routeIs('admin.dashboard') ? 'bg-yellow-500 text-gray-900' : 'hover:bg-gray-800' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('admin.dashboard') ? 'text-gray-900' : 'text-gray-400 group-hover:text-yellow-500' }} transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                ...
                <!-- MEMBER -->
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-base font-medium text-white transition duration-75 rounded-lg group {{ request()->routeIs('admin.member.*') ? 'bg-yellow-500 text-gray-900' : 'hover:bg-gray-800' }}" data-collapse-toggle="dropdown-menu-member">
                    ...
                    <ul id="dropdown-menu-member" class="hidden py-4 space-y-4 ml-10">
                        <li>
                            <a href="{{ route('admin.member.record.index') }}" 
                               class="block p-2 text-base font-bold {{ request()->routeIs('admin.member.record.*') ? 'text-yellow-500' : 'text-white' }} hover:bg-gray-800 rounded-lg">
                                Record
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.member.verification.list') }}" 
                               class="block p-2 text-base font-bold {{ request()->routeIs('admin.member.verification.*') ? 'text-yellow-500' : 'text-white' }} hover:bg-gray-800 rounded-lg">
                                Verification
                            </a>
                        </li>
                    </ul>
                ...
                <!-- FEE -->
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-base font-medium text-white transition duration-75 rounded-lg group {{ request()->routeIs('admin.fee-*') ? 'bg-yellow-500 text-gray-900' : 'hover:bg-gray-800' }}" data-collapse-toggle="dropdown-menu-fee">
                ...
                <!-- EVENT -->
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-base font-medium text-white transition duration-75 rounded-lg group {{ request()->routeIs('event.*') ? 'bg-yellow-500 text-gray-900' : 'hover:bg-gray-800' }}" data-collapse-toggle="dropdown-menu-event">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="member-event">
                ...
                <li>
                    <button type="button" 
                            class="flex items-center w-full p-2 text-base font-medium text-white transition duration-75 rounded-lg group 
                                   {{ request()->is('admin/achievement*') ? 'bg-yellow-500 text-gray-900' : 'hover:bg-gray-800' }}" 
                            data-collapse-toggle="dropdown-menu-achievement">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul id="dropdown-menu-achievement" class="hidden py-4 space-y-4 ml-10">
                        <li>
                            <a href="{{ route('merit.list') }}" 
                               class="block p-2 text-base font-bold {{ request()->routeIs('merit.*') ? 'text-yellow-500' : 'text-white' }} hover:bg-gray-800 rounded-lg">
                                Merit
                            </a>
                        </li>
                        <li>
                            <a href="/admin/achievement-certificate" 
                               class="block p-2 text-base font-bold {{ request()->is('admin/achievement-certificate*') ? 'text-yellow-500' : 'text-white' }} hover:bg-gray-800 rounded-lg">
                                Certification
                            </a>
                        </li>
                    </ul>
                ...
                <li>
                    <button type="button" 
                            class="flex items-center w-full p-2 text-base font-medium text-white transition duration-75 rounded-lg group 
                                   {{ request()->is('admin/setting*') ? 'bg-yellow-500 text-gray-900' : 'hover:bg-gray-800' }}" 
                            data-collapse-toggle="dropdown-menu-setting">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="member-setting">
                    ...
                    <ul id="dropdown-menu-setting" class="hidden py-4 space-y-4 ml-10">
                        <li>
                            <a href="{{ route('admin.settings.admins') }}" 
                               class="block p-2 text-base font-bold {{ request()->routeIs('admin.settings.admins') ? 'text-yellow-500' : 'text-white' }} hover:bg-gray-800 rounded-lg">
                                Admin
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.setting.users') }}" 
                               class="block p-2 text-base font-bold {{ request()->routeIs('admin.setting.users*') ? 'text-yellow-500' : 'text-white' }} hover:bg-gray-800 rounded-lg">
                                Users
                            </a>
                        </li>
                    </ul>
